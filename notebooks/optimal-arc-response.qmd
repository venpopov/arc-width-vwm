...
```{r}
#| label: validate-empirical-optimum
...
```{r}
#| label: empirical-optima-setsizes
...
```{r}
#| label: compare-empirical-predictions
#| message: false
...
```{r}
#| label: optimality-by-subject-setsize
#| message: false
...
```{r}
#| label: plot-optimality-by-subject
...
```{r}
#| label: population-optimum-posterior
#| message: false
#| warning: false
...
```{r}
#| label: subject-optimum-posterior
#| message: false
#| warning: false
...
```{r}
#| label: subject-optimality-violin
#| message: false
points_by_setsize_subject <- ss_exp |> 
...
```{r}
#| label: subject-optimality-score
subj_optimum_posterior |> 
